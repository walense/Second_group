...
$( function(){
		...
		$('#dg').datagrid({
		    ...
		    columns:[[    
		        ...
		        {field:'annName',title:'公告名称',width:300,align:'center',resizable:false},    
		        {field:'annContext',title:'公告内容',width:400,align:'center',resizable:false},    
		        {field:'annTime',title:'创建时间',width:300,align:'center',resizable:false},
		        {field:'announcer',title:'公告人',width:150,align:'center',resizable:false},
		...
		modiAnn = function(index){
			...
			if(UserName == row["announcer"] && pwer == 1){
